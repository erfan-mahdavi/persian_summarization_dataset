...
class DigikalaTechSpider(BaseSpider):
    name = "digikala_tech"
    allowed_domains = ["digikala.com"]
    start_urls = ["https://www.digikala.com/mag/category/science-technology/"]


    def __init__(self, *args, **kwargs):
        super(DigikalaTechSpider, self).__init__(*args, **kwargs)
        self.counter = 1
    ...
    def parse_main(self, response):
        ...
        self.counter += 1
        next_page_url = f"https://www.digikala.com/mag/category/science-technology/page/{self.counter}/"
    ...
    def parse_article(self, response):
        ...
        article = self.clean_nodes(response.css('div.post-module__content p ::text, div.post-module__content h2 ::text').getall())
        if article[-60:].find("منبع") != -1:  
