...
class DigikalaCookSpider(BaseSpider):
    name = "digikala_cook"
    allowed_domains = ["digikala.com"]
    start_urls = ["https://www.digikala.com/mag/category/fmcg"]


    def __init__(self, *args, **kwargs):
        super(DigikalaCookSpider, self).__init__(*args, **kwargs)
        self.counter = 1
    ...
    def parse_main(self, response):
        ...
        self.counter += 1
        next_page_url = f"https://www.digikala.com/mag/category/fmcg/page/{self.counter}/"
