...
class GamefaCinemaSpider(BaseSpider):
    name = "gamefa_cinema"
    allowed_domains = ["gamefa.com"]
    start_urls = ["https://gamefa.com/category/cinema/page/2/"]


    def __init__(self, *args, **kwargs):
        super(GamefaCinemaSpider, self).__init__(*args, **kwargs)
        self.counter = 2
    ...
    def parse_main(self, response):
        ...
        self.counter += 1
        next_page_url = f"https://gamefa.com/category/cinema/page/{self.counter}/"
