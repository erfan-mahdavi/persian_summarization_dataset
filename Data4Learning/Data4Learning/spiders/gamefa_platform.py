...
class GamefaPlatformSpider(BaseSpider):
    name = "gamefa_platform"
    allowed_domains = ["gamefa.com"]
    start_urls = ["https://gamefa.com/category/platform/page/2/"]



    def __init__(self, *args, **kwargs):
        super(GamefaPlatformSpider, self).__init__(*args, **kwargs)
        self.counter = 2
    ...
    def parse_main(self, response):
        ...
        self.counter += 1
        next_page_url = f"https://gamefa.com/category/platform/page/{self.counter}/"
