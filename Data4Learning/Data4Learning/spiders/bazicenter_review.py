...
class BazicenterReviewSpider(BaseSpider):
    name = "bazicenter_review"
    allowed_domains = ["bazicenter.com"]
    start_urls = ["https://www.bazicenter.com/category/review/"]

    def __init__(self, *args, **kwargs):
        super(BazicenterReviewSpider, self).__init__(*args, **kwargs)
        self.counter = 1
    ...
    def parse_main(self, response):
        ...
        self.counter += 1
        next_page_url = f"https://www.bazicenter.com/category/review/page/{self.counter}/"
    ...
    def parse_article(self, response):
        ...
        tags = self.clean_tags(response.css('span.post-cat-wrap a.post-cat::text').getall())
